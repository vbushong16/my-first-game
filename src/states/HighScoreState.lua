...
function HighScoreState:render()
    ...
    for i = 1, 10 do
        ...
        -- score number (1-10)
        love.graphics.printf(tostring(i) .. '.', VIRTUAL_WIDTH / 6, 60 + i * 20, 50, 'left')

        -- score name
        love.graphics.printf(name, VIRTUAL_WIDTH / 4 , 60 + i * 20, 100, 'right')
        
        -- score itself
        love.graphics.printf(tostring(score), VIRTUAL_WIDTH / 1.5, 60 + i * 20, 100, 'right')
    end
